...
function preload() {
  ...
  // images[1] = loadImage('https://upload.wikimedia.org/wikipedia/en/f/ff/SuccessKid.jpg');
  // "American Gothic", Grant DeVolson Wood, 1930
  // images[2] = loadImage('https://upload.wikimedia.org/wikipedia/en/f/ff/SuccessKid.jpg');
  // "La Liseuse", Jean-Honoré Fragonard, 1770
  // images[3] = loadImage('https://upload.wikimedia.org/wikipedia/en/f/ff/SuccessKid.jpg');
}

function setup() {
  // createCanvas(636, 424); // we need some space...
  /*
